...
public class CalculatorController{
    ...
    public String summa( Integer nam1,Integer nam2){
        if (nam1==null||nam2==null) {
            return "Ошибка. Параметр не подан.";
        }
        return String.valueOf(calculatorService.summa(nam1,nam2));
    }
    ...
    public String multiplication(Integer nam1,Integer nam2 ){
        ...
        return String.valueOf( calculatorService.multiplication(nam1,nam2));
    }
    ...
    public  String subtraction(Integer nam1,Integer nam2 ) {
        ...
        return String.valueOf( calculatorService.subtraction(nam1,nam2));
        }
    @GetMapping("/division")
    public String division(Integer nam1,Integer nam2 ) {
        ...
        return String.valueOf( calculatorService.division(nam1,nam2));
    }
}
